...
public class RandomShitModFeatures {
	...
	public static final RegistryObject<Feature<?>> METHPLANT = register("methplant", MethplantFeature::feature,
			new FeatureRegistration(GenerationStep.Decoration.VEGETAL_DECORATION, MethplantFeature.GENERATE_BIOMES, MethplantFeature::placedFeature));
