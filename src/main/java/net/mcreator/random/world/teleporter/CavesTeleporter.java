...
public class CavesTeleporter implements ITeleporter {
	...
	public static void registerPointOfInterest(RegistryEvent.Register<PoiType> event) {
		poi = new PoiType("caves_portal",
				com.google.common.collect.Sets
						.newHashSet(ImmutableSet.copyOf(RandomShitModBlocks.CAVES_PORTAL.get().getStateDefinition().getPossibleStates())),
				0, 1).setRegistryName("caves_portal");
